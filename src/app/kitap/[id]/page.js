    ...
    <div className="min-h-screen py-8 md:py-16 px-4 md:px-6 bg-[#fafafa] dark:bg-[#080808] transition-colors duration-1000">
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-[minmax(0,7rem)_minmax(0,1fr)] sm:grid-cols-[minmax(0,9rem)_minmax(0,1fr)] lg:flex lg:flex-row gap-x-4 gap-y-4 lg:gap-12 items-start">
          ...
          <div className={`${data.coAuthorProfile ? 'row-span-5' : 'row-span-4'} lg:row-span-1 self-start w-full lg:w-80 shrink-0`}>
...
/>
            ...
            <div className="col-start-2 grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-2 lg:gap-6 bg-white dark:bg-white/5 p-3 sm:p-4 lg:p-8 rounded-2xl lg:rounded-[2rem] border dark:border-white/5">
              <div className="text-center">
